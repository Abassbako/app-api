...
router.get('', (req, res) => {
    res.cookie('Welcome to my automatic api', [true], { 
        maxAge: 10000 * 60 * 60,
        httpOnly: [ true, 'This cookie is available only on httpOnly' ],
        secure: true
     });
    res.json({message: "Successfully created this api automatically"});
});
